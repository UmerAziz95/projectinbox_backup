                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="" class="py-1 px-2 rounded-1 purple">Administrator</a>
                                        <a href="" class="py-1 px-2 rounded-1 orange">Manager</a>
                                        <a href="" class="py-1 px-2 rounded-1 sup">Support</a>
                                        <a href="" class="py-1 px-2 rounded-1 red">Restricted User</a>
                                        <a href="" class="py-1 px-2 rounded-1 green">Users</a>
                                    </div>
                                </td>
                                <td>Basic</td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="bg-transparent p-0 border-0" data-bs-target="#addRoleModal"
                                            data-bs-toggle="modal"><i class="fa-solid fa-pen-to-square"></i></button>
                                        <div class="dropdown">
