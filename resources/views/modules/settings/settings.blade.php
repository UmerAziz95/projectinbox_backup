                    ...
                    <div class="info-container">
                        <ul class="list-unstyled mb-6">
                            <li class="mb-2">
                                ...
                                <span class="opacity-50 small fw-light">@violet.dev</span>
                            </li>
                            <li class="mb-2">
                                <span class="h6">Email:</span>
                                <span class="opacity-50 small fw-light">vafgot@vultukir.org</span>
                            </li>
                            <li class="mb-2">
                                <span class="h6">Status:</span>
                                <span class="opacity-50 small fw-light">Active</span>
                            </li>
                            <li class="mb-2">
                                <span class="h6">Role:</span>
                                <span class="opacity-50 small fw-light">Author</span>
                            </li>
                            <li class="mb-2">
                ...
                <div class="modal-body">
                    ...
                    <form id="editUserForm" class="row gy-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select id="userStatus" name="userStatus" class="form-select" aria-label="User status">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit"
                                    class="m-btn py-2 px-4 rounded-2 border-0 ">Submit</button>
